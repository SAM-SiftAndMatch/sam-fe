...
const FREELANCERS = [
  {
    ...
    description:
      'Chuyên gia phát triển ứng dụng Web với 5 năm kinh nghiệm. Từng làm việc tại VNG, FPT Software.',
  },
  {
    id: '2',
    name: 'Trần Thị B',
    ...
    location: 'Hà Nội',
    description:
      'Thiết kế giao diện người dùng thân thiện, hiện đại. Tập trung vào trải nghiệm và tối ưu tỷ lệ chuyển đổi.',
  },
  {
    id: '3',
    name: 'Lê Văn C',
    ...
    location: 'Đà Nẵng',
    description:
      'Có kinh nghiệm xây dựng hệ thống dữ liệu lớn, ETL pipelines và tối ưu hóa truy vấn CSDL.',
  },
  {
    id: '4',
    name: 'Phạm Thị D',
    ...
    location: 'Hồ Chí Minh',
    description:
      'Đã đưa hơn 20 website lên top 1 Google. Viết bài chuẩn SEO, tăng traffic tự nhiên bền vững.',
  },
];
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500">
              Tìm kiếm nhân tài phù hợp cho dự án của bạn từ hàng ngàn chuyên gia.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {FREELANCERS.map((freelancer) => (
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4 line-clamp-2">{freelancer.description}</p>
